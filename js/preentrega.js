...
function mostrarCard (array){
  array.map(producto => {
    ...
    card.innerHTML = `
      <div class="card">
        <h3 class="">${producto.title}</h3>
        <img src="${producto.image}" class="img">
        <h4 class="">Categoria: ${producto.category}</h4>
        <p class="">Precio en dolareques verdes ricos: ${producto.price}</p>
      </div>
    `;
...
function mostrarCarrito (){
  ...
  modalContainer.append(containerItems) 
    ...
    carrritoItem.className ='cart-item'
